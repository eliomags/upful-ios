...
class LoggingManagerTests: XCTestCase {
    ...
    func test_log_withBuyAndSell() {
        ...
        let fbBuy = TransactionViewModel(ticker: "FB", shares: 1, averagePrice: 100, currentPrice: 100)
        let fbSell = TransactionViewModel(ticker: "FB", shares: 1, averagePrice: 200, currentPrice: 200)
        ...
        // Check if order is correct after another buy
                    let anotherFBbuy = TransactionViewModel(ticker: "FB", shares: 1, averagePrice: 150, currentPrice: 150)
