...
class LoggingManagerTests: XCTestCase {
    ...
    func test_log_withBuyAndSell() {
        ...
        let fbBuy = Transaction(ticker: "FB", shares: 1, averagePrice: 100, currentPrice: 100)
        let fbSell = Transaction(ticker: "FB", shares: 1, averagePrice: 200, currentPrice: 200)
        ...
        // Check if order is correct after another buy
                    let anotherFBbuy = Transaction(ticker: "FB", shares: 1, averagePrice: 150, currentPrice: 150)
