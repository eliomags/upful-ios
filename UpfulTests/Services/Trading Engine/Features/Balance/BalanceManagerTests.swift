...
class BalanceManagerTests: XCTestCase {
    ...
    func test_handleBuy_balanceUpdates() {
        let transaction1 = Transaction(ticker: "FB", shares: 1, averagePrice: 100, currentPrice: 100)
        ...
        let transaction2 = Transaction(ticker: "FB", shares: 1, averagePrice: 900, currentPrice: 900)
