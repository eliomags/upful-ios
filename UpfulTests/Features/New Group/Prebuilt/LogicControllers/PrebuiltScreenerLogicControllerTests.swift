...
final class MockRemoteScreenerLoader: RemoteScreenerLoaderProtocol {
    ...
    private func handleSuccess() -> [ScreenerViewModel] {
        let vm1 = ScreenerViewModel(title: "Title0", description: "", searchParameters: [], interest: 0, documentID: "testID", colorMap: nil, symbol: "nil")
         let vm2 = ScreenerViewModel(title: "Title1", description: "", searchParameters: [], interest: 0, documentID: "testID", colorMap: nil, symbol: "nil")
         let vm3 = ScreenerViewModel(title: "Title2", description: "", searchParameters: [], interest: 0, documentID: "testID", colorMap: nil, symbol: "nil")
         let vm4 = ScreenerViewModel(title: "Title3", description: "", searchParameters: [], interest: 0, documentID: "testID", colorMap: nil, symbol: "nil")
