...
class HomeGeneralLogicControllerTests: XCTestCase {

    var sut: HomeGeneralLogicController!
    ...
    func makeSUTWithData() -> HomeGeneralLogicController {
...
//        // when initialized
//
//        sut = HomeGeneralLogicController(savedStockDataManager: MockSavedStockDataLoader(), preferenceDataManager: preferenceManager)
//
//        // then
//
