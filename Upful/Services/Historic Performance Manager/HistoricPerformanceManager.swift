...
final class HistoricPerformanceMapper {
    ...
    var loadTransactions = LocalTransactionLedgerLoader().loadAllPersistedTransactions
    ...
    func createDayPerformanceDataPoints() {
        ...
        for bucket in transactionBuckets {
            ...
            let performance = DailyPerformance(holdingBalance: holdingBalance, cashBalance: newCashBalance, date: bucket.date)
